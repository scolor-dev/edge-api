/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5c3c4b7e498162e0f8223d92bc05549a)
// Runtime types generated with workerd@1.20260518.1 2026-05-09 
interface __BaseEnv_CloudflareBindings {
	SCD_ASSETS: R2Bucket;
	SCD_CONTENTS: R2Bucket;
	SCD_DB: D1Database;
	ALLOWED_ORIGIN: "https://scolor-dev.work, https://admin.scolor-dev.work, *.portfolio-admin-6bg.pages.dev";
	CF_TEAM_DOMAIN: "";
	CF_ACCESS_AUD: "";
}
